 ...
 * @description Visuals class handles manipulation of all visual aspects of the game.
 * @constructor
...
UltimateLib.Visuals = (function (self) {
    // Show up in console
    ...
    */
    ...
    self.setLayoutCss = function (modfolder) {
        ...
        a.attr("href", ".mods\/" + modfolder + "\/css\/layout.css");
    };
    ...
    self.Tweaks = (function (self) {
        ...
        */
        self.setRoundedWindows = function (radius) {
            if (store.settings.roundedCorners === false) {
        ...
        */
        self.setScrollBar = function (style) {
            if (store.settings.scrollBar === false) {
        ...
        */
        self.setRoundedButtons = function (radius) {
            if (store.settings.roundedButtons === false) {
        ...
        */
        self.setRoundedBars = function (radius) {
            if (store.settings.roundedBars === false) {
        ...
        */
        self.setTextBox = function (radius) {
            if (store.settings.textBox === false) {
        ...
        */
        self.setFancyGrads = function (style) {
            if (store.settings.fancyGrads === false) {
